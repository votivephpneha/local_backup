    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('edit.voucher.code.post',$vouchercodedata->id)}}" enctype="multipart/form-data">
              @csrf
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="price">Name <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="voucher_name" name="voucher_name"  class="form-control col-md-7 col-xs-12" value="{{$vouchercodedata->name}}">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="voucher_code" name="voucher_code"  class="form-control col-md-7 col-xs-12" value="{{$vouchercodedata->voucher}}">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="discount" id="discount"  class="form-control">
                      ...
                      <option value="0"  {{ ($vouchercodedata->discount == 0) ? 'selected' : '' }} >Flat</option>

                      <option value="1" {{ ($vouchercodedata->discount == 1) ? 'selected' : '' }}>Percentage</option>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="number" id="amount" name="amount"  class="form-control col-md-7 col-xs-12" value="{{$vouchercodedata->amount}}">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="number" id="mamount" name="mamount"  class="form-control col-md-7 col-xs-12" value="{{$vouchercodedata->apply_min_amount}}">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="date" id="valid_till" name="valid_till"  class="form-control col-md-7 col-xs-12" value="{{$vouchercodedata->valid_till}}"> 
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="voucher_status" id="voucher_status"  class="form-control">
                      ...
                      <option value="1" {{ ($vouchercodedata->status == 1) ? 'selected' : '' }} >Active</option>

                      <option value="0" {{ ($vouchercodedata->status == 0) ? 'selected' : '' }}>Inactive</option>
